...
<html lang="en">
  <head>
    ...
    <title>Contact Us — Cubiertos</title>
  ...
  <body>
    <header class="glass-header">
      <div class="nav-container">
        ...
        <nav class="navbar">
          ...
          <a href="../HTML/contacts.php" class="active">Contacts</a>
        </nav>
        <?php if ($isLoggedIn): ?>
    ...
    <section class="hero">
      <div class="hero-content">
        <h1>Contact Us</h1>
        <p>Questions, reservations or feedback — we're here to help. Visit or call our Virac branch.</p>
      </div>
    </section>
    ...
    <section class="contact-section">
      ...
      <div class="contact-layout">
        <div class="contact-info-side">
          <span class="mini-title">WE ARE HERE FOR YOU</span>
          <h2>Reach Out To <span>Cubiertos</span></h2>
          <p class="desc">Questions, reservations, or feedback — we'd love to hear from you. Visit our branch or send us a message!</p>
          <div class="contact-features">
            <div class="contact-feature-card">
              <div class="icon-circle"><i class="fa-solid fa-phone"></i></div>
              <div><h4>Call Us</h4><a href="tel:+639810270704">0981 027 0704</a></div>
            </div>
            <div class="contact-feature-card">
              <div class="icon-circle"><i class="fa-solid fa-location-dot"></i></div>
              <div><h4>Visit Us</h4><p>Along Imelda Blvd., Rawis, Virac, Catanduanes</p></div>
            </div>
            <div class="contact-feature-card">
              <div class="icon-circle"><i class="fa-solid fa-envelope"></i></div>
              <div><h4>Email Us</h4><p>support@cubiertos.com</p></div>
            </div>
          </div>
        </div>
          ...
          <div class="form-card">
            ...
            <form id="contactForm" class="contact-form" novalidate>
              ...
              <div class="form-row">
                ...
                <input id="phone" name="phone" type="tel" placeholder="Ex. 0954 678 9012" required />
              </div>
              <div class="form-row">
                <label>Have you tasted our dishes?</label>
                <div class="radio-options">
                  <label class="radio-box"><input type="radio" name="tasted" value="Yes"> Yes</label>
                  <label class="radio-box"><input type="radio" name="tasted" value="No"> No</label>
                </div>
              </div>
              <div class="form-row">
                <label for="message">What can we do for you? <span>*</span></label>
                <textarea id="message" name="message" rows="5" required></textarea>
              </div>
              <div class="form-actions">
                <button type="submit" class="submit-btn">SUBMIT FORM &rarr;</button>
              </div>
            </form>
          </div>
        </div>
